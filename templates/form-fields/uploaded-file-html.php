...
<div class="wpum-uploaded-file">
	...
	if ( 3 !== strlen( $extension ) || in_array( $extension, array( 'jpg', 'gif', 'png', 'jpeg', 'jpe' ) ) ) : ?>
		<span class="wpum-uploaded-file-preview"><img src="<?php echo esc_url( $value ); ?>" /> <a class="wpum-remove-uploaded-file" href="#">[<?php _e( 'remove' ); ?>]</a></span>
	<?php else : ?>
		<span class="wpum-uploaded-file-name"><code><?php echo esc_html( basename( $value ) ); ?></code> <a class="wpum-remove-uploaded-file" href="#">[<?php _e( 'remove' ); ?>]</a></span>
	<?php endif; ?>
